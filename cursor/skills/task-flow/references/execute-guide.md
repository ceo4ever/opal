...
EXECUTE 중 TODO.md의 Step 상태를 실시간으로 갱신한다:

| 시점 | 변경 |
|------|------|
| Step 실행 시작 | ⬜ 대기 → 🔄 진행 중 |
| Step 테스트 통과 | 🔄 진행 중 → ✅ 완료 |
| Step 블로커 발생 | 🔄 진행 중 → 🚫 블로커 |
| 블로커 해결 후 재시작 | 🚫 블로커 → 🔄 진행 중 |
