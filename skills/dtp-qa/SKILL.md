...
- **실행 주체**: QA 전용 워커 에이전트 (dtp-qa-dev-agent 또는 dtp-qa-wireframe-agent)
...
```
Read ~/.opal/skills/dtp-qa/personas/qa-engineer.md
```
...
| 단계 | 가이드 |
|------|--------|
| ANALYSIS | `Read ~/.opal/skills/dtp-qa/references/qa-dev-guide.md` |
| PLAN | `Read ~/.opal/skills/dtp-qa/references/qa-dev-guide.md` |
| WIREFRAME | `Read ~/.opal/skills/dtp-qa/references/qa-wireframe-guide.md` |
| EXECUTE-UI | `Read ~/.opal/skills/dtp-qa/references/qa-wireframe-guide.md` |
