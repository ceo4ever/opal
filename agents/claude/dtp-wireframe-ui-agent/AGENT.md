...
1. `{프로젝트}/.cursor/skills/{skill-name}/SKILL.md`
2. `{프로젝트}/.claude/skills/{skill-name}/SKILL.md`
3. `{프로젝트}/.agent/skills/{skill-name}/SKILL.md`
4. `~/.cursor/skills/{skill-name}/SKILL.md`
5. `~/.claude/skills/{skill-name}/SKILL.md`
6. `~/.gemini/antigravity/skills/{skill-name}/SKILL.md`
