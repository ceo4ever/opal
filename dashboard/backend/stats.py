...
def _workflow_entry(
    ...
    for state in members:
        ...
        tasks.append({
            ...
            # 2계열 승계 — 워크플로우 대기 비중의 분자·분모를 태스크 단위로 되짚는다
            "work_minutes": static["work_minutes"],
            "wait_minutes": static["wait_minutes"],
