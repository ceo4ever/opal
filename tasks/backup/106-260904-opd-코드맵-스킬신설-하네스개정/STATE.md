...
| 8 | 2026-09-05 15:29:32 | additional row inserted after row 21: stage=CLOSE, item=ADD-2: code-scan 헤더 창문 단위 비대칭 회귀 테스트 신설 (ADD_DONE-1 이월 1-a), key=close.add_2, new_row_id=22 | additional work entry |
| 9 | 2026-09-05 15:50:40 | current_status changed: additional_work → additional_work_done | ADD-2 완료: 문자/바이트 비대칭 회귀 테스트 4건 신설, code-scan 344/0 |
